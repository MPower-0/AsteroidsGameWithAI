...
public class IntelligentAsteroid : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.tag == "Bullet")
        {
            ...
            FindObjectOfType<GameManager>().AIAsteroidDestroyed(this);
    ...
    private void Split()
    {
        ...
        IntelligentAsteroid half = Instantiate(this, position, this.transform.rotation);
